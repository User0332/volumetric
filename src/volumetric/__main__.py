...
"""
CSR_RENDER_WORKER_CODE = f"""// Note: This file was automatically generated by the volumetric CLI tool and should NOT be removed or edited if CSR support is required.
