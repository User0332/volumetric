...
"""
CSR_RENDER_WORKER_CODE = f"""// Note: This file was automatically generated by the volumetric CLI tool and should NOT be removed if CSR support is required.
...
"""
	...
	if csr:
		...
		open(f"{name}/static/js/render-worker.js", 'w').write(
			CSR_RENDER_WORKER_CODE
		)
